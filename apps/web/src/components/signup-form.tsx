      ...
      <div className="flex w-full max-w-[480px] flex-col gap-10">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-base leading-relaxed text-[#8C8782]">
            Join Lineage to build, visualize, and share your family tree. Collaborate with relatives
            and preserve your heritage for generations to come.
          </p>
        </div>
        <div className="flex flex-col gap-4">
...
function SsoSection() {
  const hasGoogle = !!env.BELONG_GOOGLE_CLIENT_ID;
  const hasGithub = !!env.BELONG_GITHUB_CLIENT_ID;
      ...
      <div className="flex flex-1 items-center justify-center bg-[#F5F2E9] p-16">
        <div className="flex w-full max-w-[400px] flex-col gap-8">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-[#5E5954]">Get started with Lineage for free</p>
          </div>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="last-name" className="text-[13px] font-medium text-[#2D2926]">
                  Last name
                </Label>
                <Input
                  id="last-name"
